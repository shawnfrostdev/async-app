...
import app.async.data.model.PlayerInfo
import app.async.R
import androidx.core.graphics.scale
import androidx.glance.unit.ColorProvider
import app.async.data.model.QueueItem
import app.async.utils.createScalableBackgroundBitmap
import timber.log.Timber

class AsyncGlanceWidget : GlanceAppWidget() {
    ...
    private fun WidgetUi(
        ...
        val title = playerInfo.songTitle.ifEmpty { "Async" }
