...
import app.async.presentation.components.NavBarContentHeight
import app.async.presentation.components.UnifiedPlayerSheet
import app.async.presentation.components.getNavigationBarHeight
import app.async.presentation.components.AllFilesAccessDialog
import app.async.presentation.navigation.AppNavigation
import app.async.presentation.navigation.Screen
import app.async.presentation.screens.SetupScreen
import app.async.presentation.viewmodel.MainViewModel
import app.async.presentation.viewmodel.PlayerViewModel
import app.async.ui.theme.DarkColorScheme
import app.async.ui.theme.LightColorScheme
import app.async.ui.theme.AsyncTheme
...
import app.async.presentation.components.NavBarContentHeight
import app.async.presentation.components.MiniPlayerHeight
import app.async.presentation.components.PlayerInternalNavigationBar
import javax.annotation.concurrent.Immutable
import androidx.core.net.toUri
import app.async.presentation.components.DismissUndoBar
import app.async.presentation.components.NavBarContentHeight
import app.async.presentation.components.NavBarContentHeightFullWidth
...
import app.async.presentation.components.MiniPlayerBottomSpacer
    ...
    private fun MainUI(playerViewModel: PlayerViewModel, navController: NavHostController) {
        ...
        val commonNavItems = remember {
            persistentListOf(
                ...
                BottomNavItem("Settings", R.drawable.rounded_settings_24, R.drawable.rounded_settings_24, Screen.Settings)
            )
        }
            ...
            bottomBar = {
                if (!shouldHideNavigationBar) {
                    ...
                    val conditionalShape = if (showPlayerContentArea) {
                        ...
                        AbsoluteSmoothCornerShape(
                            cornerRadiusTL = navBarCornerRadius.dp,
                            smoothnessAsPercentBR = 60,
                            cornerRadiusTR = navBarCornerRadius.dp,
                            smoothnessAsPercentTL = 60,
                            cornerRadiusBL = 0.dp,
                            smoothnessAsPercentTR = 60,
                            cornerRadiusBR = 0.dp,
                    ...
                    Box(
                        ...
                        val navHeight = NavBarContentHeight + systemNavBarInset
...
//                            )
    ...
    fun PermissionsNotGrantedScreen(onRequestPermissions: () -> Unit) {
        Column(
            ...
            Text(
                text = "Async needs access to your audio files to scan and play your music. Please grant permission to continue.",
