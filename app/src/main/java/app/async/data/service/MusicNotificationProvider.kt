...
class MusicNotificationProvider(
    ...
    companion object {
        const val CUSTOM_COMMAND_SHUFFLE_ON = "app.async.SHUFFLE_ON"
        const val CUSTOM_COMMAND_SHUFFLE_OFF = "app.async.SHUFFLE_OFF"
        const val CUSTOM_COMMAND_CYCLE_REPEAT_MODE = "app.async.CYCLE_REPEAT"
        const val CUSTOM_COMMAND_LIKE = "app.async.LIKE"
    }
}
