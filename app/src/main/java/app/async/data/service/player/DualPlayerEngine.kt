package app.async.data.service.player
...
import app.async.utils.envelope
...
class DualPlayerEngine @Inject constructor(
    ...
    fun performTransition(settings: TransitionSettings) {
        ...
        transitionJob = scope.launch {
            when (settings.mode) {
                app.async.data.model.TransitionMode.FADE_IN_OUT -> performFadeInOutTransition(settings)
                app.async.data.model.TransitionMode.OVERLAP, app.async.data.model.TransitionMode.SMOOTH -> performOverlapTransition(settings)
                app.async.data.model.TransitionMode.NONE -> {
